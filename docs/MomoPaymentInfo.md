...
------------ | ------------- | ------------- | -------------
**rail** | **String** | The payment rail type for mobile money transfers | 
**addressing_system** | **String** | The addressing system used for mobile money transfers | 
...
**provider** | **String** | The mobile money service provider | 
