...
**external_tx_id** | Option<**String**> | Unique external transaction identifier provided by the user. Used to help prevent duplicate transactions. | [optional]
...
**blockchain_info** | Option<**serde_json::Value**> | A JSON used to store additional blockchain-specific data.  **Example:** In HBAR, this property will have the txHash in addition to the txID.  | [optional]
...
**contract_call_decoded_data** | Option<[**models::TransactionResponseContractCallDecodedData**](TransactionResponseContractCallDecodedData.md)> |  | [optional]
...
**address_type** | Option<**AddressType**> |  (enum: , WHITELISTED, ONE_TIME) | [optional]
