...
------------ | ------------- | ------------- | -------------
**rail** | **Rail** | The payment rail type for SPEI transfers (enum: SPEI) | 
**addressing_system** | **AddressingSystem** | The addressing system used for SPEI transfers (enum: CLABE) | 
