...
------------ | ------------- | ------------- | -------------
**rail** | **Rail** | The payment rail type for US wire transfers (enum: US_WIRE) | 
**addressing_system** | **AddressingSystem** | The addressing system used for US wire transfers (enum: ABA) | 
