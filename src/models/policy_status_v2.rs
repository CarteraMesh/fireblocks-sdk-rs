...
/// PolicyStatusV2 : * SUCCESS - success * UNVALIDATED - not validated yet *
...
impl std::fmt::Display for PolicyStatusV2 {
...
impl Default for PolicyStatusV2 {
    fn default() -> PolicyStatusV2 {
        Self::Success
    }
}
