...
pub struct GetOwnershipTokensParams {
    ...
    /// A comma separated list of Vault Account IDs. Up to 100 are allowed in a
    /// single request.  This field will be ignored when
    ...
    /// Search owned tokens and their collections. Possible criteria for search:
    /// token name and id within the contract/collection, collection name,
    /// blockchain descriptor and name.
...
pub struct ListOwnedCollectionsParams {
    ...
    /// Wallet type, it can be `VAULT_ACCOUNT` or `END_USER_WALLET`
    pub wallet_type: Option<String>,
    /// Search owned collections. Possible criteria for search: collection name,
