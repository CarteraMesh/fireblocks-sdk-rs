...
pub trait WorkspaceManagementApi: Send + Sync {
    ...
    ) -> Result<models::UserGroupCreateResponse, Error<UpdateUserGroupError>>;
}
...
impl WorkspaceManagementApi for WorkspaceManagementApiClient {
    ...
    async fn create_api_user(
        ...
        let local_var_uri_str =
            format!("{}/management/api_users", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateApiUserError> =
    ...
    async fn create_console_user(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateConsoleUserError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn delete_user_group(
        ...
        let DeleteUserGroupParams { group_id } = params;
    ...
    async fn get_audits(
        ...
        let GetAuditsParams { time_period } = params;
    ...
    async fn get_user_group(
        ...
        let GetUserGroupParams { group_id } = params;
    ...
    async fn get_whitelist_ip_addresses(
        ...
        let GetWhitelistIpAddressesParams { user_id } = params;
    ...
    async fn reset_device(&self, params: ResetDeviceParams) -> Result<(), Error<ResetDeviceError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ResetDeviceError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
