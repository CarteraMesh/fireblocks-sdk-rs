...
pub trait KeyLinkApi: Send + Sync {
    ...
    /// only for Key Link enabled workspaces. </br>Endpoint Permission: Admin
    ...
    /// workspaces. </br>Endpoint Permission: Admin and Non-Signing Admin.
    ...
    /// endpoint is available only for Key Link enabled workspaces.
    ...
    /// enabled workspaces. </br>Endpoint Permission: Admin and Non-Signing
    /// Admin.
    ...
    /// is available only for Key Link enabled workspaces. </br>Endpoint
